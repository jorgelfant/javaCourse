...
public class Voiture {//Un objeto tiene//propiedades//estado//comportamiento
    ...
    public Voiture() {//CONSTRUCTEUR même nom que la classe CONSTRUCTEUR DE BASE AVEC ETAT INITIAL
        roues = 4;
        longueur = 2000;//cms
        largeur = 300;
        puissance = 1600;
