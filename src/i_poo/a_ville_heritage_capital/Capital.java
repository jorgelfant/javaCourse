...
public class Capital extends Ville {//HERITE le contenu (propriétés méthodes, de ville)
    ...
    */
    ...
    // *****************************************************************************************************************
                                 //el constructor padre tiene una exception asi que el hijo debe tenerla tambien
    public Capital(String nomVille, int pNbre, String nomPays, String monument) throws NombreHabitantException,NomVilleException {
        super(nomVille, pNbre, nomPays);
