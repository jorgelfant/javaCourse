package i_poo.v_design_patterns.A_Modelos_de_Creation.III_Builder_Fluent.ejemplo_13_bis;

public class Main {
  public static void main(String[] args) {
    //The next code listing shows my Person class from above with a Builder added into it as a nested class.
  }
}
...
/*The Builder can be even nicer when enhanced through use of custom types and parameters objects as outlined in my
first two posts on the "too many parameters" problem. This is shown in the next code listing.*/
