package i_poo.v_design_patterns.A_Modelos_de_Creation.III_Builder_Fluent.ejemplo_8;
...
public class TestBuilderPattern {
  public static void main(String[] args) {
    ...
    /*
     ...
     1) Too Many arguments to pass from client program to the Factory class that can be error prone because most of
     ...
     client program. For this we need to have a private constructor in the Class with Builder class as argument.
      ...
      Here is the sample builder pattern example code where we have a Computer class and ComputerBuilder class
      to build it.
