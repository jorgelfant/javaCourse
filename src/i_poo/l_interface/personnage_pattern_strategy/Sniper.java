...
import i_poo.l_interface.personnage_pattern_strategy.combat.CombatFusil;
...
*/
    ...
    //CONSTRUCTOR 1
    public Sniper() {
        this.setEspritCombatif(new CombatFusil()); //utilizamos el seter para cambiar el valor de la variable par defaut
